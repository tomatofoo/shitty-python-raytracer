...
class Game(object):
    ...
    def __init__(self: Self) -> None:
        ...
        self._scene = Scene(
            objects={
                Floor(0, 2, (255, 255, 255), (0, 0, 0), 0.25),
                Sphere((-3, 1, 12), 1, (255, 0, 0), 0.5),
                Sphere((0, 1, 12), 1, (0, 255, 0), 0.5),
                Sphere((3, 1, 12), 1, (0, 0, 255), 0.5),
                Sphere((-3, 3, 12), 1, (0, 255, 255), 0.5),
                Sphere((0, 3, 12), 1, (255, 0, 255), 0.5),
                Sphere((3, 3, 12), 1, (255, 255, 0), 0.5),
                Sphere((-3, 5, 12), 1, (0, 0, 0), 0.5),
